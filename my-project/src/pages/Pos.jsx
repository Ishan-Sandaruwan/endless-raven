...
export default function Pos() {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        const res = await fetch("/api/projects/get-all?type=pos");
  ...
  return (
    <div className="w-full min-h-[70vh] bg-gradient-to-r from-amber-100 via-white to-orange-200 p-12 ">
      {loading ? (
          ...
          <div className="flex gap-2 lg:h-[50vh] flex-col lg:flex-row">
            <div className="flex-1 flex flex-col gap-4 justify-center py-4 ">
              <h1 className="xl:text-5xl text-3xl font-semibold text-red-700 drop-shadow-md lg:pb-8 pb-2">
                {" "}
                Discover The  <span className="font-bold"> Softwares</span>  That We Are Proud Of
              </h1>
