...
export default function OurTeam() {
  ...
  return (
    <div className="max-w-5xl w-[80%] mx-auto ">
      <h2 className="heading">Our Crew</h2>
      <h3 className="mb-2 text-lg text-justify text-slate-800">
        Meet the Innovators of our Endless Solutions
      </h3>
      <p className="mb-6 text-justify">
        Our tech team of skilled programmers are dedicated to developing and maintaining 
        exceptional technological solutions. We navigate challenges, celebrate success and work hard towards a shared 
        vision of excellence.
        Each member brings a unique perspective, inclusivity and diversity to the projects we develop.
      </p>
