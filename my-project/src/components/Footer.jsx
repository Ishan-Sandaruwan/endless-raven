      ...
      <div class="flex flex-wrap rows items-start justify-center gap-4">
        ...
        <div class="w-[300px]">
          ...
          <div class="text-justify text-sm">
            Welcome to Endless Raven, where the solution are infinte and the innovations are Endless.
            We are an IT company dedicated in creating top-notch products to pursue the limits of 
            technologies.
            From revolutionary software technologies and cutting-edge IT services, out team is commited in guiding you towards endless creative solutions. 
          </div>
        </div>
