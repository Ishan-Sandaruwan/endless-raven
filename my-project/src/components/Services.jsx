  ...
  return (
    <div id="services" className="max-w-5xl w-[80%] mx-auto mb-20 lg:mb-32 lg:flex lg:flex-row-reverse lg:items-center">
      <div className="lg:w-[35%]">
        <h2 className="heading">Our services include</h2>
        <p className="text-justify mb-8">
          Specializing in web, app, software and mobile development.
          From dynamic websites to creative software platforms and solid mobile apps, we deliver
          exceptional products that exceed expectations and empower businesssses to excel in the digital era. 
        </p>
      </div>
