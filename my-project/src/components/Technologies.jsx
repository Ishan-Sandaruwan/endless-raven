...
export default function Technologies() {
  ...
  return (
    <div className="max-w-5xl w-[80%] mx-auto mb-20 lg:mb-32">
      ...
      <p className="">
        Experience the fusion of web, app, and software technologies at your
        fingertips. We leverage HTML, CSS, JavaScript, React
        Native, Flutter, Python, and Java to create endless solutions.
      </p>
